    ...
    <div className="min-h-screen flex items-center justify-center bg-pixelDark">
      <form onSubmit={handleSubmit} className="bg-pixelGray border-4 border-pixelYellow rounded-lg shadow-pixel p-8 flex flex-col gap-4 w-full max-w-xs">
        ...
        <input
          ...
          required
        />
        <button type="submit" className="mt-2 px-6 py-2 bg-pixelYellow text-pixelGray border-2 border-pixelYellow rounded font-pixel text-base shadow-pixel hover:bg-pixelOrange hover:text-white transition-all">Sign In</button>
